...
namespace MSFSTouchPortalPlugin_Generator.Configuration
{
  internal class GeneratorOptions
  {
    ...
    [Option('j', "JsonFile", Default = "entry.tp", MetaValue = "<entry.tp>", Required = false,
      HelpText = "\nJSON output file name. Default is 'entry.tp'")]
    ...
    [Option("StateFiles", Default = null, MetaValue = "<LIST>", Separator = ',', Required = false,
    ...
    [Option("StateFilesPath", Default = "", MetaValue = "<DIR>", Required = false,
